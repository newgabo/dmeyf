...
kscript         <- "epic_stacking"

karch_dataset    <- "./datasets/dataset_epic_simple_v006.csv.gz"   #este dataset se genero en el script 812_dataset_epic.r
...
hs <- makeParamSet( 
         ...
         makeIntegerParam("min_gain_to_split", lower=   0.0 , upper= 0.7),
...
ksemilla_azar  <- 372205  #Aqui poner la propia semilla
#------------------------------------------------------------------------------
