...
meses_training <- c(202001, 202002, 202003, 202004, 202005, 202006, 202007, 202008, 202009)
meses_validation <- c(202011)
...
hs <- makeParamSet( 
         ...
         makeNumericParam("reg_alpha",       lower=  0.0    , upper=  100.0),
         makeNumericParam("reg_lambda",       lower=  0.0    , upper=  200.0),
...
dtrain  <- lgb.Dataset( data=    data.matrix(  dataset[ train==1 , campos_buenos, with=FALSE]),
  ...
  param_basicos  <- list( boosting_type="rf",
...
dapply  <- copy( dataset[  foto_mes %in% meses_validation] )
dim(dapply)
