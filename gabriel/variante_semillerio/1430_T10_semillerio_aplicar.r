...
x  <- list()
x$gleaf_size   <-  79.28045394
x$gnum_leaves  <-  0.528820195
x$learning_rate <-  0.020091154
x$feature_fraction <-  0.396636265
x$max_bin  <-  183
x$num_iterations  <-   785


meses_total <- c(202001, 202002, 202003, 202004, 202005, 202006, 202007, 202008, 202009, 202010, 202011, 202011)
