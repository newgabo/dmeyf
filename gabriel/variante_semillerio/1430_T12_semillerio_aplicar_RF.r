...
x  <- list()
x$gleaf_size   <-  92.60291311
x$gnum_leaves  <-  0.591477568
x$learning_rate <-  0.199984991
x$feature_fraction <-  0.632773436
x$max_bin  <-  23
x$num_iterations  <-   25



meses_total <- c(202001, 202002, 202003, 202004, 202005, 202006, 202007, 202008, 202009, 202010, 202011, 202101)
meses_training <- c(202001, 202002, 202003, 202004, 202005, 202006, 202007, 202008, 202009, 202010, 202011)
...
param_buenos  <- list( boosting_type="rf",
                       bagging_freq=1, 
